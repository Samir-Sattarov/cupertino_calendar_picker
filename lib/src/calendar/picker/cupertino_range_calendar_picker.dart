...
class CupertinoRangeCalendarPicker extends StatefulWidget {
  ...
  @override
  CupertinoRangeCalendarPickerState createState() =>
      CupertinoRangeCalendarPickerState();
}

class CupertinoRangeCalendarPickerState
    extends State<CupertinoRangeCalendarPicker> {
  ...
  void initState() {
    ...
    _selectedDateTime = widget.selectedStartDate;
  ...
  @override
  void didUpdateWidget(CupertinoRangeCalendarPicker oldWidget) {
    ...
    if (widget.selectedStartDate != oldWidget.selectedStartDate ||
      ...
      _rangeStart = widget.selectedStartDate;
      _rangeEnd = widget.selectedEndDate;
      _selectedDateTime = _rangeEnd ?? _rangeStart ?? _selectedDateTime;
    }
  }
  ...
  void _onMonthDateChanged(DateTime dateTime) {
    // Normalize to date-only for range logic
    final DateTime tapped = DateUtils.dateOnly(dateTime);

    DateTime? start =
        _rangeStart != null ? DateUtils.dateOnly(_rangeStart!) : null;
    DateTime? end = _rangeEnd != null ? DateUtils.dateOnly(_rangeEnd!) : null;

    if (start == null && end == null) {
      start = tapped;
      end = tapped;
    } else if (start != null && end != null) {
      // Start new range from tapped
      start = tapped;
      end = tapped.isBefore(start) ? start : tapped;
    } else if (start != null) {
    ...
    _rangeStart = start;
    _rangeEnd = end;
    _selectedDateTime = end ?? start ?? tapped;
